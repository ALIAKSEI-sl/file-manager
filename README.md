## Чтобы переименовать, создавать, копировать, перемещать, удалять, архивировать и разархивировать файлы в некоторых директориях на диске С могут понадобиться права администратора, если появилось сообщение Operation failed при верных переданных путях, запустите File Manager с правами администратора или тестируйте команды на другом локальном диске. Для перехода на другой диск используй путь name_drive:\(например D:\) или абсолютный путь к файлу или директории.
